...
const SiteNav = () => {
    ...
    return (
        <div className="nav_div">
            ...
            <Container>
            <Navbar.Brand href="#home">Blockbuster-Show</Navbar.Brand>
            ...
            <Navbar.Collapse id="responsive-navbar-nav">
                <Nav className="me-auto">
                    ...
                    <NavLink to="/myprofile" className="nav_menu">My Profile</NavLink>
                    {
                ...
                </Nav>
                {
                    ...
                    <Nav>
                        ...
                        <NavDropdown className="nav_icon" title={<FontAwesomeIcon icon={faUserCircle} />} id="collasible-nav-dropdown">
